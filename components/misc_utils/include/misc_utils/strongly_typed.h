 ...
 *
 * @example struct MyStrongInt : StronglyTyped<MyStrongInt, int>
 *          {
 *              using StronglyTyped<MyStrongInt, int>::StronglyTyped;
 *          };
 *
...
struct StronglyTyped
{
    ...
    StronglyTyped &operator=(const StronglyTyped &) noexcept = default;
    constexpr StronglyTyped(StronglyTyped &&) noexcept = default;
    StronglyTyped &operator=(StronglyTyped &&) noexcept = default;
